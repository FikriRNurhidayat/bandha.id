...
enum WhenOption {
  ...
  static List<WhenOption> get min => [
    WhenOption.now,
    WhenOption.specificTime,
  ];

  static List<WhenOption> get notEmpty => [
    WhenOption.now,
    WhenOption.today,
...
class XWhenFormField extends FormField<When> {
  XWhenFormField({
    super.key,
    super.initialValue,
    super.onSaved,
    ...
    bool readOnly = false,
         ...
         builder: (field) {
           final state = field as _XWhenFormFieldState;
  ...
  @override
  FormFieldState<When> createState() => _XWhenFormFieldState();
}

class _XWhenFormFieldState extends FormFieldState<When> {
