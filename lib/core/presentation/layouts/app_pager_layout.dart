...
class AppPagerLayout<Model> extends StatelessWidget {
  final String title;
  final ValueListenable<AsyncSnapshot<Pager<Model>>> valueListenable;
  final WidgetBuilder builder;
  final Widget? floatingActionButton;

  const AppPagerLayout({
    super.key,
    required this.title,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ValueListenableBuilder<AsyncSnapshot<Pager<Model>>>(
