...
class LoanPaymentEditView extends StatefulWidget {
  final String loanId;
  final String? entryId;
  final bool readOnly;

  const LoanPaymentEditView({
    super.key,
  ...
  @override
  State<LoanPaymentEditView> createState() => LoanPaymentEditViewState();
}

class LoanPaymentEditViewState extends State<LoanPaymentEditView> {
