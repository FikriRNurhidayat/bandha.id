...
class EditTransferView extends StatefulWidget {
  final Transfer? transfer;

  const EditTransferView({super.key, this.transfer});

  @override
  State<EditTransferView> createState() => _EditTransferViewState();
}

class _EditTransferViewState extends State<EditTransferView> {
