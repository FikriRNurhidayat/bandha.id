...
class FundTransactionEditView extends StatefulWidget {
  final String fundId;
  final String? entryId;
  final bool readOnly;

  const FundTransactionEditView({
    super.key,
  ...
  @override
  State<FundTransactionEditView> createState() =>
      FundTransactionEditViewState();
}

class FundTransactionEditViewState extends State<FundTransactionEditView> {
