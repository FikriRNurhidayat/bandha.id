...
class FundEditView extends StatefulWidget {
  final String? id;
  final bool readOnly;

  const FundEditView({super.key, this.id, this.readOnly = false});

  @override
  State<FundEditView> createState() => _FundEditViewState();
}

class _FundEditViewState extends State<FundEditView> {
